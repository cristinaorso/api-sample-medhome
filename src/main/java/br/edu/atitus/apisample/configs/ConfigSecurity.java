...
public class ConfigSecurity {
    ...
    public SecurityFilterChain getFilterChain(HttpSecurity http, AuthTokenFilter filterToken) throws Exception {
        http.sessionManagement(session -> session
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/ws**", "/ws/**").authenticated() //rotas que iniciarem com ws serão protegidas, qualquer outra como /greeting será pública
    ...
    @Bean
    //objetivo: criptografar a senha em Hash
